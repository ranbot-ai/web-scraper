...
const SOCIAL_LINKS = ['https://instagram.com/', 'https://www.instagram.com/', 'http://instagram.com/', 'http://www.instagram.com/',
                      'https://linkedin.com/', 'https://www.linkedin.com/', 'http://linkedin.com/', 'http://www.linkedin.com/',
                      'https://facebook.com', 'https://www.facebook.com', 'http://facebook.com', 'http://www.facebook.com',
                      'https://twitter.com', 'https://www.twitter.com', 'http://twitter.com', 'http://www.twitter.com',
                      'https://g2.com',
                      'https://trustpilot.com', 'https://www.trustpilot.com/',
                      'https://discord.com/', 'https://discord.gg/',
                      'https://www.tiktok.com/@',
                      'https://www.pinterest.com/'];

const SOCIAL_LINKS_TO_EXCLUDE = [/https\:\/\/(www\.)?instagram\.com\/p\//,
